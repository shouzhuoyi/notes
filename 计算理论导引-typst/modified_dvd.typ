...
#let dvdtyp(
  ...
  set page(
    ...
    header: context {
      ...
      box(stroke: (bottom: 0.7pt), inset: 0.2em)[#text(font: (
  ...
  set text(font: ("New Computer Modern Sans", "STKaiti"), lang: "en")
  ...
  show outline.entry.where(level: 1): it => {
    text(font: ("New Computer Modern Sans", "Source Han Serif SC"), accent)[#strong[#it]]
  }
  show outline.entry: it => {
    text(font: ("New Computer Modern Sans", "Source Han Serif SC"), accent)[#it]
  }
...
#let thmtitle(t, color: rgb("#000000")) = {
  text(font: ("New Computer Modern Sans", "Source Han Serif SC"), weight: "semibold", fill: color)[#t]
}
#let thmname(t, color: rgb("#000000")) = {
  text(font: ("New Computer Modern Sans", "Source Han Serif SC"), fill: color)[(#t)]
}
...
#let thmtext(t, color: rgb("#000000")) = {
  ...
  text(font: ("New Computer Modern Sans", "STKaiti"), fill: color)[#t]
}
...
#let quote-style = builder-thmbox(color: colors.at(6), shadow: (offset: (x: 3pt, y: 3pt), color: luma(70%)))

//#let quote = quote-style("quote", "Quote")
